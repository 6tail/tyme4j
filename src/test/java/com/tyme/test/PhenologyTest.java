...
public class PhenologyTest {
  ...
  public void test0() {
    ...
    Assert.assertEquals("2020年4月19日 22:45:28", phenology.getPhenology().getJulianDay().getSolarTime().toString());
    // 该候的第5天
  ...
  public void test1() {
    ...
    Assert.assertEquals("2021年12月26日 21:48:54", phenology.getPhenology().getJulianDay().getSolarTime().toString());
    // 该候的第1天
  ...
  public void test2() {
    ...
    Assert.assertEquals("2025年12月26日 20:49:53", jd.getSolarTime().toString());
  }
  ...
  @Test
  public void test4() {
    Assert.assertEquals("蚯蚓结", SolarTime.fromYmdHms(2025, 12, 26, 20, 49, 52).getPhenology().getName());
    Assert.assertEquals("麋角解", SolarTime.fromYmdHms(2025, 12, 26, 20, 49, 53).getPhenology().getName());
  }
